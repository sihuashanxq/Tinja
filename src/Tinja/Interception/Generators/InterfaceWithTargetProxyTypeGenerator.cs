...
namespace Tinja.Interception.Generators
{
    public class InterfaceWithTargetProxyTypeGenerator : ProxyTypeGenerator
    {
        ...
        public InterfaceWithTargetProxyTypeGenerator(Type interaceType, Type implemetionType)
            : base(interaceType, implemetionType)
        {
        ...
        {
            CreateField("__target", ProxyTargetType, FieldAttributes.Private);
